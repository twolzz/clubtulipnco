...
export const FREE_SHIPPING_THRESHOLD_CENTS = 5000; // $50.00 — free shipping STRICTLY ABOVE this
export const FLAT_SHIPPING_CENTS = 600; // $6.00 flat rate at or below the threshold
